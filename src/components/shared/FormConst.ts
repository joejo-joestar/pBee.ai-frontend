export const toggle =
  "rounded-xl p-3.5 m-auto text-center text-lg text-violet-200 duration-200 hover:bg-violet-300/30 hover:duration-200 has-[:checked]:bg-cardColor has-[:checked]:text-white has-[:checked]:shadow-cardGlowEffect";
...
export const setButton =
  "rounded-xl w-36 text-center text-lg text-violet-200 duration-200 bg-cardColor hover:text-white hover:shadow-cardGlowEffect";

export const inputField =
  "bg-tabContainer w-40 rounded-xl border-2 border-violet-500 p-3";
